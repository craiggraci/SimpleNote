...
public class SonicNote extends SilentNote implements Note {
    ...
    public static void resetCompleteSonicNoteSet(LinkedList<SonicNote> completeSonicNoteSet) {
...
//    }
//
    public SonicNote(NoteFrame f, String prefix) {
        super();
        mcf = f;
        textOutputArea = mcf.ta();
        player = new Player();
    ...
    public void playMusicString() {
        textOutputArea.append(">>> playMusicString()\n");
        player = new Player();
